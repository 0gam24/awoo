...
- **구글 색인률 KPI(2026-08-28~, 도메인 신뢰 회복 추적)**: 표본 기준 구글 색인률 %를 매회 기록·직전 대비 증감 보고. 색인 요청은 허브·성과 글 집중(일 10건 내, 무차별 금지). 30%+ 회복 시 발행 속도 제한 해제 검토 제안 (GOOGLE-NAVER-DUAL-STANDARD §5·§6)
