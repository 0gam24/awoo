...
- 지역 적용 가능 주제(월세·난방비·청년수당·출산·지자체 사업)는 **지역+페르소나 조합을 최소 2~3개** 포함 (예: "파주시 청년 월세 지원 대상자", "부산 영도구 신혼부부 전세자금"). 지역축을 단순 옵션이 아니라 우선축으로 취급.
- 전국 단위 정책도 브로드 헤드("정부 지원금"·"청년 지원금") 금지 — 대상자+수치+조건으로 구체화.
- 지역 spoke가 여럿이면 검색량 큰 수도권 시·군구 우선, `/subsidies/category/[category]/persona/[persona]` 4축 hub와 연계.
