...
>
> **⚠️ 검증 정정 (2026-06-03, 1차 출처 korea.kr 정책브리핑·fsc.go.kr 보도자료 확인)**
> - 제도 **실재·정부 확정** 확인(2026년 6월 출시). 발행 가능.
> - **소득기준 정정**: 본문 일부의 '일반형 6,000만/우대형 3,600만'은 부정확. 실제 = **총급여 7,500만원 이하(종합소득 6,300만) 또는 소상공인 매출 3억 이하 + 가구 중위소득 200% 이하**(동시 충족). 일반형/우대형 구분은 **기여금 비율(6%/12%)**.
> - **나이**: 만 19~34세(병역 최대 6년 미산입, 청년도약계좌 종료 후 35세 된 청년 예외 허용).
> - **확정**: 월 50만·3년·기여금 6/12%·이자비과세·연 2회(6·12월)모집·비대면 앱(서민금융진흥원).
> - **미확정(단정 금지)**: 금리(일부 보도 '연 5% 고정' 언급, 정부 최종공시 대상)·은행별 우대금리·정확한 신청 개시/마감일. 발행 전 fsc.go.kr 원문 재확인.
