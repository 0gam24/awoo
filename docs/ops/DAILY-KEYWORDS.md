# 키워드 후보 보고 — 2026-09-19 (KST)

생성 2026-09-19 05:23Z · scripts/keyword-pipeline.mjs
SERP 실측: scout 24/35건(T1 15·T2 5·재측정 5)
입력: cluster-intents 63건 · naver-ranks 57쿼리 · 레이더 candidates 47건(지역 후보 소스: radar.candidates) · volume-scale 계수 13 · big-keywords 12 · landgrab 9 · 글 279건
후보: T1 1 · T2 6 · T3 1 · 갱신 25 · 제외 100
...
|---|---|---|---|---|---|---|
| 1 | 높음 75 | T2 | 2026 주휴수당 포함 시급 | 자리 열림 · 빈자리 6 · 위에 관공서 없음 | 현재 94/주 | [보류] 검색 결과 실측 필요 |
...
| 5 | 중간 65 | T2 | 청년월세 월세지원 사업 | 자리 열림 · 위에 관공서 없음 | 52~122 | 자매 주의: 청약·전세대출 각도는 homedata.kr·asiatop.co.kr 몫(청약·대출 금지). awoo는 선정·중복 수급·주거급여 · 인접 글 youth-rent-support-selection-announcement-2026-09-10 — 각도 분리 |
| 6 | 중간 50 | T1 A | 창원 지원금 (창원) | 자리 열림 · 공고 URL 필요 | 현재 60/주(자사 미노출·미측정분 회수) | 공고 go.kr URL 확보 + 접미형·변형 SERP 실측 |

T2 나머지 1건(점수순, 큐 JSON에 있음): 장애인고용장려금(57.4)
...
| # | 글 | 날짜 | 고칠 것 | 근거 |
|---|---|---|---|---|
| 1 | 부안군 민생안정지원금 30만원, 대상 기준일과 지급 일정 (src/data/issues/2026-08-19/buan-livelihood-stability-grant-2026-08-19.json) | 2026-09-19 D-day | 오늘 마감·지급일 — 당일 표기 | scout 2026-09-19: "부안군 민생안정지원금 못 받았으면" r1, "부안군 민생안정지원금 9월 16일 출장 지급 이후" r1 — B 쿼리를 기존 A글이 받는다 · B키 사실("부안군 민생안정지원금 못 받았으면")을 기존 글에 updates[]·표 행으로 추가 |
| 2 | 추석 온누리상품권 환급 참여시장과 6만7천원에 2만원 받는 법 (src/data/issues/2026-09-16/chuseok-onnuri-voucher-refund-market-2026-09-16.json) | 2026-09-20 D-1 | 1일 뒤 마감·지급일 — 카운트다운·마감 안내 정정 | coreFacts.deadline "2026-09-20 환급 마감, 예산 소진 시 조기 종료될 수 있음" · 날짜 2026-09-20 D-1 · 갱신 이력 없음 |
| 3 | 창원 민생지원금 지급하나요? 8월 27일 미지급 결정 (src/data/issues/2026-08-28/changwon-livelihood-grant-not-paid-2026-08-28.json) | 2026-09-21 D-2 | 2일 뒤 마감·지급일 — 카운트다운·마감 안내 정정 | coreFacts.deadline "미지급 결정 2026년 8월 27일, 지류 누비전 9월 1일 200억원(취약계층 우선구매일), 일반 판매 9월 2일 오전 9시, 지류 2차 9월" · 날짜 2026-09-21 D-2 · 갱신 이력 없음 |
| 4 | 강릉 민생지원금 10만원 재상정안 통과 시 지급 시점과 정례회 일정 (src/data/issues/2026-09-03/gangneung-livelihood-grant-resubmission-2026-09-03.json) | 2026-09-22 D-3 | 3일 뒤 마감·지급일 — 카운트다운·마감 안내 정정 | coreFacts.deadline "지급일 미정. 표결 후보는 제332회 정례회 9월 9일 제2차 본회의 또는 9월 22일 제3차 본회의(폐회일)이며 회기 중 조례안 접수·상임위 " · 날짜 2026-09-22 D-3 · 갱신 이력 없음 |
| 5 | 부안군 민생안정지원금 30만원, 대상 기준일과 지급 일정 (src/data/issues/2026-08-19/buan-livelihood-stability-grant-2026-08-19.json) | 2026-09-18 D+1 | 마감·지급일 1일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "지급 2026.09.16~09.18(읍·면 현지출장 집중 지급) / 사용기한 2026.11.30까지" · 날짜 2026-09-18 D+1 (+ 2026-09-16 D+3) · 갱신 이력 없음 · 계획 §5 이정표: 출장 지급 9/16~18 개시(2026-09-16) |
| 6 | 추석 민생지원금 최대 50만원, 소비쿠폰과 중복 수급되나 (src/data/issues/2026-08-07/chuseok-livelihood-coupon-duplicate-2026-08-07.json) | 2026-09-18 D+1 | 마감·지급일 1일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "추석(9월 25일) 전 지급 목표 / 의령 신청 8.10~9.11, 부안 지급 9.16~18, 통영 이르면 8월 말 신청(지자체 공고로 확정)" · 날짜 2026-09-18 D+1 (+ 2026-09-16 D+3) · dateModified 2026-08-07 |
| 7 | 고흥 민생지원금 언제 나오나, 30만원 추진 상황 정리 (src/data/issues/2026-08-19/goheung-livelihood-grant-2026-08-19.json) | 2026-09-18 D+1 | 마감·지급일 1일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "9월 1일 확정 발표: 2026.9.14~18 마을 방문 지급(1차), 9.21~10.30 읍면사무소 신청, 사용기한 2026.12.31(지류 " · 날짜 2026-09-18 D+1 (+ 2026-09-21 D-2, 2026-09-14 D+5) · dateModified 2026-09-05T22:58:49.000Z · 계획 §5 이정표: 마을 지급 9/14~18 개시(2026-09-14) |
| 8 | 나주 민생회복지원금 5부제, 내 출생연도 신청일은 9월 며칠인가 (src/data/issues/2026-09-03/naju-livelihood-grant-rotation-days-2026-09-03.json) | 2026-09-18 D+1 | 마감·지급일 1일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "온라인·방문 공통 2026.09.14~10.16(시 공식 게시물), 첫 주 9.14~18 출생연도 끝자리 5부제. 온라인 안내의 출생연도 무관 " · 날짜 2026-09-18 D+1 (+ 2026-09-21 D-2, 2026-09-14 D+5) · 갱신 이력 없음 |
| 9 | 9월 18일 신설 배우자 유산·사산휴가, 유급은 며칠일까 (src/data/issues/2026-09-01/spouse-miscarriage-stillbirth-leave-2026-09-01.json) | 2026-09-18 D+1 | 마감·지급일 1일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "2026년 9월 18일 시행. 신청 방법·서류는 시행 전까지 별도 공지 예정" · 날짜 2026-09-18 D+1 · 갱신 이력 없음 |
| 10 | 김해 민생회복지원금 사용처, 카드·상품권 차이와 11월 30일 기한 (src/data/issues/2026-09-16/gimhae-grant-usage-places-card-voucher-2026-09-16.json) | 2026-09-17 D+2 | 마감·지급일 2일 지남 — 종료 표기·다음 절차로 정정 | 계획 §5 이정표: 지급 예정일 9/17 · 날짜 2026-09-17 D+2 · 갱신 이력 없음 |
| 11 | 김해시 민생지원금 10만원 신청 대상, 9월 17일 지급 (src/data/issues/2026-08-12/gimhae-livelihood-grant-2026-08-12.json) | 2026-09-17 D+2 | 마감·지급일 2일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "신청 2026-09-17 09:00~10-30 18:00(첫 주 9/17~23 출생연도 끝자리 요일제), 사용기한 2026-11-30 23:59" · 날짜 2026-09-17 D+2 · dateModified 2026-09-16 · 계획 §5 이정표: 지급 예정일 9/17(2026-09-17) |
| 12 | 대구 추석지원금 전 시민 지급 없음, 군위 54만원은 1월분 (src/data/issues/2026-09-15/daegu-chuseok-grant-check-2026-09-15.json) | 2026-09-16 D+3 | 마감·지급일 3일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "9월 16일 본회의 추경 의결 예정, 원안에 전 시민 지원금 없음" · 날짜 2026-09-16 D+3 · 갱신 이력 없음 |
| 13 | 2026 2학기 국가장학금 2차 신청 9월 9일 마감, 재학생 구제 (src/data/issues/2026-07-28/national-scholarship-2nd-round-2026-07-28.json) | 2026-09-16 D+3 | 마감·지급일 3일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "2차 신청 8월 12일(수) 9시~9월 9일(수) 18시 / 서류·가구원 동의 9월 16일(수) 18시까지" · 날짜 2026-09-16 D+3 · dateModified 2026-09-09 · 0400-queue 2026-09-09 update 지정과 겹침 |
| 14 | 2026 근로장려금 대상 기준 가구유형 3가지부터 갈린다 (src/data/issues/2026-09-13/eitc-2026-eligibility-criteria-2026-09-13.json) | 2026-09-15 D+4 | 마감·지급일 4일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "상반기분 반기신청 2026년 9월 15일 마감" · 날짜 2026-09-15 D+4 · 갱신 이력 없음 |
| 15 | 맞벌이 부부 근로장려금 반기 선지급, 명의·환수 주의 (src/data/issues/2026-08-26/eitc-semiannual-dual-income-2026-08-26.json) | 2026-09-15 D+4 | 마감·지급일 4일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "상반기분 반기신청 2026.9.1~9.15(선지급 2026.12월 말) / 하반기분 2027.3.1~3.15(정산 2027.6월)" · 날짜 2026-09-15 D+4 · 갱신 이력 없음 |
| 16 | 추석 민생회복지원금 우리 지역 대상·신청 조회 방법 (src/data/issues/2026-07-30/chuseok-livelihood-recovery-region-check-2026-07-30.json) | 2026-09-14 D+5 | 마감·지급일 5일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "2026 추석(9월 25일) 전 지급 지자체 증가 / 신청·지급·사용기한은 지자체 공고로 확정(속초 신청 7.20~9.11·나주 9.14부터)" · 날짜 2026-09-14 D+5 · dateModified 2026-07-30 |
| 17 | 고흥군 민생회복지원금 30만원, 추석 전 고흥사랑상품권 지급 (src/data/issues/2026-08-17/goheung-livelihood-recovery-grant-2026-08-17.json) | 2026-09-14 D+5 | 마감·지급일 5일 지남 — 종료 표기·다음 절차로 정정 | 계획 §5 이정표: 마을 지급 9/14~18 개시 · 날짜 2026-09-14 D+5 · 갱신 이력 없음 |
| 18 | 생계·의료급여 수급 근로가구 희망저축계좌 9월 3차 모집 D-4 (src/data/issues/2026-08-28/hope-savings-account-type1-round3-2026-08-28.json) | 2026-09-14 D+5 | 마감·지급일 5일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "Ⅰ유형 3차 접수 2026년 9월 1일~14일, 놓치면 4차 11월 2일~16일 예정" · 날짜 2026-09-14 D+5 · 갱신 이력 없음 |
| 19 | 문경 고유가 지원금 25만원, 9월 14일 신청 (src/data/issues/2026-08-16/mungyeong-high-oil-price-relief-2026-08-16.json) | 2026-09-14 D+5 | 마감·지급일 5일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "신청 2026년 9월 14일~10월 23일 / 선불카드 사용기한 2026년 12월 31일까지" · 날짜 2026-09-14 D+5 · 갱신 이력 없음 |
| 20 | 문경 민생지원금 추석 전 지급되나, 9월 1일 추경 관건 (src/data/issues/2026-08-27/mungyeong-livelihood-grant-chuseok-payment-2026-08-27.json) | 2026-09-14 D+5 | 마감·지급일 5일 지남 — 종료 표기·다음 절차로 정정 | coreFacts.deadline "접수 2026년 9월 14일~10월 23일, 추경 예산은 9월 8일 시의회 의결로 확정(추석 전 지급 목표 유지)" · 날짜 2026-09-14 D+5 · dateModified 2026-09-13 |
...
- [T1] 대구 V — 보류: 확인 불가 — 첫 주 제외(계획 §5) · B 트리거: "대구 추석지원금" rank null(통블록)(2026-09-19)
...
- [T1] 신안 B — B 트리거: "신안군 민생지원금" r4(2026-09-19) → cluster-intents VETO: 신안 × B 이미 존재: sinan-grant-100k-application-2026-09-12(2026-09-12). coreFacts 미제공 → FIX 검사 생략(--who/--amount/--deadline 또는 --facts)
- [T1] 영암 B — B 트리거: "영암군 민생지원금" r10(2026-09-19) → cluster-intents VETO: 영암 × B 이미 존재: yeongam-wolchulpay-balance-expiry-use(2026-09-16). 잠금 제외 1건(롤업·비민생) · coreFacts 미제공 → FIX 검사 생략(--who/--amount/--deadline 또는 --facts)
...
- [T2] 주휴수당 포함 시급 — recent7 1.33 < 1.5(radar)
...
- [T2] 근로장려금 계산기 — recent7 0.36 < 1.5(radar)
...
- [T2] 청년내일저축계좌 — 기존 글 있음 — youth-savings-account-maturity-guide-2026-06-20(제목에 이 표현 포함). 새 글 아님
...
- [T2] 2026 재난지원금 — scout 2026-09-19 verdictT2 closed: "2026 재난지원금" already r2, openSlots 0<2, news-warn 같은 제목 4·7일 58건, offset·press 미측정(API) — 자사 이미 r2 — 신규 불필요
- [T2] 9월14일 민생지원금 — scout 2026-09-19 verdictT2 closed: "9월14일 민생지원금" already r2, openSlots 0<2, offset·press 미측정(API) — 자사 이미 r2 — 신규 불필요
- [T2] 조기취업수당 조건 — scout 2026-09-19 verdictT2 closed: "조기취업수당 조건" already r3, openSlots 1<2, offset·press 미측정(API) — 자사 이미 r3 — 신규 불필요
- [T2] 근로·자녀장려금 9월 신청 전 구분 3가지 — scout 2026-09-19 verdictT2 closed: "근로·자녀장려금 9월 신청 전 구분 3가지" already r3, openSlots 0<2, offset·press 미측정(API) — 자사 이미 r3 — 신규 불필요
- [T2] 청년월세지원사업 — scout 2026-09-19 verdictT2 closed: "청년월세지원사업" openSlots 1<2, offset·press 미측정(API) — 재측정 후 재판정
- [T2] 청년월세지원금 — scout 2026-09-19 verdictT2 closed: "청년월세지원금" openSlots 1<2, offset·press 미측정(API) — 재측정 후 재판정
- [T2] 실업급여 구직급여 — scout 2026-09-19 verdictT2 closed: "실업급여 구직급여" openSlots 0<2, offset·press 미측정(API) — 재측정 후 재판정
- [T1] 4차 민생지원금 지역별 지급 현황 — scout 2026-09-19 verdictT1 closed: "4차 민생지원금 지역별 지급 현황" already r2, openSlots 1<2, offset·press 미측정(API) / "4차 민생지원금 9월 신청 지역" already r1, openSlots 0<2, offset·press 미측정(API) / "4차 민생지원금 개시일" already r2, openSlots 1<2, offset·press 미측정(API) — 자사 이미 r1 — 신규 불필요
- [T1] 정읍시 민생지원금 — scout 2026-09-19 verdictT1 closed: "정읍시 민생지원금" already r2, openSlots 1<2, offset·press 미측정(API) — 자사 이미 r2 — 신규 불필요
- [T1] 부안군 민생안정지원금 못 받았으면 — scout 2026-09-19 verdictT1 closed: "부안군 민생안정지원금 못 받았으면" already r1, openSlots 0<2, offset·press 미측정(API) / "부안군 민생안정지원금 9월 16일 출장 지급 이후" already r1, openSlots 0<2, offset·press 미측정(API) — 자사 A글(buan-livelihood-stability-grant-2026-08-19)이 이미 r1 — 신규 대신 그 글 갱신(결정 #2, 갱신 후보에 올림)
...
- 나주 — 개시 09/14 D+5 · 신규 없음. D-1·D+1 재측정, 4위 이하면 B(계획 §5)
- 문경 — 개시 09/14 D+5 · 신규 없음. 9/16 B 필요 여부 판단(계획 §5) (판단일 2026-09-16)
...
- 연말정산 월세 세액공제 — writeBy 2026-11-05(D-47) · 피크 1월 76.21
- 연말정산 부양가족 — writeBy 2026-11-15(D-57) · 피크 1월 16.51
- 연말정산 의료비 — writeBy 2026-11-25(D-67) · 피크 1월 14.08
- 연말정산 연금저축 — writeBy 2026-12-05(D-77) · 피크 1월 7.49
- 연말정산 경정청구 — writeBy 2026-12-20(D-92) · 피크 5월 12.9
- 완주 신청·지급 마감 10/30 카운트다운 정정(계획 §7-2) — 2026-10-30(D-41) 갱신 예정 · wanju-livelihood-stability-grant-2026-08-12, wanju-grant-proxy-application-after-sep14
- 나주 계획 §7-2 기재 카운트다운 날짜(9/30 — 세부 내용 확인 불가) — 2026-09-30(D-11) 갱신 예정 · naju-livelihood-recovery-grant-2026-08-07, naju-livelihood-grant-rotation-days-2026-09-03
- 나주 신청 마감 10/16 카운트다운 정정(계획 §7-2) — 2026-10-16(D-27) 갱신 예정 · naju-livelihood-recovery-grant-2026-08-07, naju-livelihood-grant-rotation-days-2026-09-03
- 문경 신청 마감 10/23 — 2026-10-23(D-34) 갱신 예정 · mungyeong-high-oil-price-relief-2026-08-16, mungyeong-livelihood-grant-chuseok-payment-2026-08-27
- 영동 영동페이 신청 마감 10/2 — 2026-10-02(D-13) 갱신 예정 · local-livelihood-support-payment-2026-07-15, yeongdong-livelihood-stability-grant-2026-08-18
- 영암 신청 마감 10/30 — 2026-10-30(D-41) 갱신 예정 · yeongam-rural-basic-allowance-100k, yeongam-wolchulpay-balance-expiry-use
- 재측정 "2026 김해 민생지원금": r1 · 본청 0 · 뉴스7일 10·같은제목 1 · openSlots 0 · 눈 확인 전
- 재측정 "김해시 지원금": 자사 미노출 · 본청 0 · 뉴스7일 95·같은제목 3 · openSlots 1 · 눈 확인 전
- 재측정 "통영 지원금 신청": r6 · 본청 0 · 뉴스7일 18·같은제목 1 · openSlots 0 · 눈 확인 전
- 재측정 "문경시 지원금": r2 · 본청 0 · 뉴스7일 31·같은제목 1 · openSlots 0 · 눈 확인 전
