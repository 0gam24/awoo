...
생성 2026-09-11 01:34Z · scripts/keyword-pipeline.mjs
SERP 실측: scout 19/25건(T1 15·T2 5·재측정 5)
...
| # | 트랙 | 쿼리 | 근거 | 예상 유입/주 | 조건 |
|---|---|---|---|---|---|
| 1 | T1 A 롤업 | 4차 민생지원금 지역별 지급 현황 · 변형: 4차 민생지원금 9월 신청 지역 / 4차 민생지원금 개시일 | 롤업 축 "4차" × A — 기존 롤업 chuseok-livelihood-recovery-region-check-2026-07-30(추석 축) · recent7 455·trend 2.46(volume-scale volumesUsed). rank-targets 2026-09-10: 자사 미노출·web4·본청 0 · rank-targets: 4차축 롤업 후보 자리. 2026-09-10 SERP: 자사 미노출·web4(블로그2·상업1·중원구청1), 본청 0·언론 0 · recent7 455.89(volume-scale) · 계수 rollup/null 50.5(n=1) · scout 2026-09-11: 자사 미노출 · 본청 0 · 언론 0 · 자매 0 · openSlots 2 · offset 66.8% · T1 closed · T2 closed · 변형 "4차 민생지원금 9월 신청 지역": r2 · 본청 0 · 언론 0 · 자매 0 · openSlots 1 · offset 8.6% · T1 closed · T2 closed · 변형 "4차 민생지원금 개시일": 자사 미노출 · 본청 0 · 언론 0 · 자매 0 · openSlots 2 · offset 11.7% · T1 open · T2 open · 점수 46044.9 | 50~500 | 변형 2개 webDocOffset <30%(결정 #4). 07-30 추석 롤업 잠식 시 noindex · 타깃(제목 선두)을 변형으로: "4차 민생지원금 개시일" — 본 쿼리 "4차 민생지원금 지역별 지급 현황"는 offset 66.8%≥30 · 자사 글이 이미 "4차 민생지원금 9월 신청 지역" r2 — 그 글을 잠식하지 않는 각도(A키 선두)로만 |
| 2 | T2 | 월세 세액공제 월세환급금 | big-keywords "월세 세액공제" alias "월세환급금" · recent7 23.15(big-keywords datalab rel30(proxy)) · 클러스터 실유입 51/주 · 계수 national/null 36.8(n=1) · scout 2026-09-11: 자사 미노출 · 본청 0 · 언론 0 · 자매 0 · openSlots 4 · offset 25.5% · T1 open · T2 open · 점수 3407.7 | 511~1193 | 초안 있음(_drafts/monthly-rent-refund-lookup) — 신규 대신 초안 완성 여부 먼저 · 자매 주의: 연말정산 절세 각도는 smartdatashop.kr·asiatop.co.kr, 임대·부동산 각도는 homedata.kr 몫.  · webDocOffset 25.5% 경고(15~30%) |
| 3 | T2 | 에너지바우처 잔액조회 | big-keywords "에너지바우처" alias "잔액조회" · recent7 10.09(big-keywords datalab rel30(proxy)) · "에너지바우처 잔액 조회" naver-ranks 2026-09-10: 자사 미노출 · openSlots 6 · 자매 0 · T2 open · 계수 national/null 36.8(n=1) · 점수 1485.2 | 223~520 | 자매 주의: 역할표에 직접 겹치는 자매 없음. 부동산·주거비 각도(homedata.kr)와만 거리 유지. · 인접 글 oil-relief-usage-period-merchants-2026-07-08 — 각도 분리 |
| 4 | T2 | 기초연금 소득인정액 | big-keywords "기초연금" alias "소득인정액" · recent7 3.74(big-keywords datalab rel30(proxy)) · "기초연금 수급자격 소득인정액 계산" naver-ranks 2026-09-10: 자사 미노출 · openSlots 2 · 자매 0 · T2 open · 클러스터 실유입 138/주 · 계수 national/null 36.8(n=1) · 점수 275.3 | 83~193 | 자매 주의: 연금·은퇴 설계 각도는 retiredata.kr 몫. awoo는 수급자격·소득인정액·개편 영향 각도만. 국민연금 연계 감액은  |
| 5 | T2 | 실업급여 상실신고 | big-keywords "실업급여" alias "상실신고" · recent7 2.66(big-keywords datalab rel30(proxy)) · 클러스터 실유입 340/주 · 계수 national/null 36.8(n=1) · scout 2026-09-11: 자사 미노출 · 본청 0 · 언론 0 · 자매 0 · openSlots 2 · offset 16.2% · T1 open · T2 open · 점수 195.8 | 59~137 | 자매 주의: 지원금 축은 awoo 고유. '실업급여 계산기' 각도는 calculatorhost.com, 사회초년생 첫 실직 각도는 asia · webDocOffset 16.2% 경고(15~30%) |
| 6 | T2 | 중위소득 계산 | big-keywords "중위소득" alias "계산" · recent7 1.68(radar) · SERP 이력 없음 · 클러스터 실유입 146/주 · 계수 national/null 36.8(n=1) · 점수 123.6 | 37~87 | SERP 미측정 — --serp로 openSlots ≥2·자매 0 확인 · 자매 주의: '중위소득 계산기' 각도는 calculatorhost.com과 겹칠 수 있다. awoo는 급여별(생계·주거·의료) 문턱 표 각 · 인접 글 youth-future-savings-calculator-2026-06-03, early-reemployment-allowance-2026-06-16 — 각도 분리 |

T2 나머지 1건(점수순, 큐 JSON에 있음): 주휴수당 포함 시급(119.2)
...
- [T2] 월세 세액공제 경정청구 — scout 2026-09-11 verdictT2 closed: "월세 세액공제 경정청구" offset 54.4%≥30 — 재측정 후 재판정
- [T2] 근로장려금 대상 기준 — scout 2026-09-11 verdictT2 closed: "근로장려금 대상 기준" openSlots 1<2, offset 30%≥30 — 재측정 후 재판정
- [T2] 실업급여 구직급여 — scout 2026-09-11 verdictT2 closed: "실업급여 구직급여" openSlots 1<2, offset 49.3%≥30 — 재측정 후 재판정
...
- [T1] 영암군 농촌기본수당 10만원 하반기 신청 — scout 2026-09-11 verdictT1 closed: "영암군 농촌기본수당 10만원 하반기 신청" press 7>3 / "영암 농촌기본수당 월출페이 9월 7일" press 11>3 — 재측정 후 재판정
...
- 재측정 "통영시 민생지원금 신청": r2 · 본청 1 · 언론 0 · openSlots 0 · offset 20.2%
- 재측정 "2026 김해 민생지원금": r1 · 본청 0 · 언론 0 · openSlots 0 · offset 23.2%
- 재측정 "김해시 지원금": r5 · 본청 0 · 언론 3 · openSlots 4 · offset 29.8%
- 재측정 "통영 지원금 신청": r2 · 본청 1 · 언론 0 · openSlots 0 · offset 14.1%
- 재측정 "문경시 지원금": r4 · 본청 1 · 언론 0 · openSlots 1 · offset 16.9%
